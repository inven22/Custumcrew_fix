...
class CleaningCategory extends StatefulWidget {
  const CleaningCategory({Key? key}) : super(key: key);

  @override
  _CleaningCategoryState createState() => _CleaningCategoryState();
}

class _CleaningCategoryState extends State<CleaningCategory> {
  List assistants = [];
  bool isLoading = true;
